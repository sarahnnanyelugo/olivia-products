...
export const WholeSalePage: React.FC = () => {
  ...
  const options: Option[] = [
    { id: "myCheckbox05", label: "Retailer" },
    { id: "myCheckbox06", label: "E-Commerce" },
    { id: "myCheckbox07", label: "Corporate Gifti" },
    { id: "myCheckbox08", label: "Hospitality" },
    { id: "myCheckbox09", label: "Distributor" },
    { id: "myCheckbox09", label: "Janitorial/Cleaning Services" },
    { id: "myCheckbox09", label: "Non-Profit" },
    { id: "myCheckbox09", label: "Government" },
    { id: "myCheckbox09", label: "Approved Broker" },
  ];
