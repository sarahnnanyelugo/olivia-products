  ...
  return (
    <div className="wholesale-page col-md-6 offset-md-3">
      <form>
        ...
        <p>
          By clicking the checkbox below, I agree to the terms and conditions
          noted in Olivia Product's homepage found at{" "}
          <Link>https://www.olivia-products.com/terms-and-conditions .</Link>{" "}
        </p>
      </form>
    </div>
  );
