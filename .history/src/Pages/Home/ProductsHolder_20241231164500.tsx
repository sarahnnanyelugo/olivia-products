...
import CartOffcanvas from "../CartOffcanvas"; // Import the shared offcanvas component
import MainProduct from "../../Components/MainProducts/MainProducts"; // assuming this is where you display each product
