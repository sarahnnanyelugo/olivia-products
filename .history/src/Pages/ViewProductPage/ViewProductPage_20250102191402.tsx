...
export const ViewProductPage: React.FC = () => {
  ...
  return (
    <div className="product-detail d-md-flex">
      ...
      <div className="product-images col-md-6 d-flex">
        <div className="image-thumbnails col-3">
      ...
      <div className="product-info col-md-6 " style={{ marginTop: "100px" }}>
        <h2>{product.name}</h2>
